...
export interface ListingFiltersProps {
  listings: Listing[];
  // Union of configured-search brands and this-page brands — computed by the caller (see
  // (app)/listings/page.tsx) since it also needs `searches`, which this component doesn't fetch.
  brands: string[];
